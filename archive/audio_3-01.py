...
class JingleDetector:
    ...
    def detect_jingles(self, audio_file_path: str) -> List[float]:
        ...
        try:
            ...
            print(f"[{self._get_timestamp()}] Audio loaded: {len(audio) / self.sample_rate / 60:.1f} minutes")
...
def main():
    ...
    # Configuration
    audio_file_path = "file3.m4b"  # Update this path if your file is elsewhere
    template_path = "jingle_template.wav"
    output_directory = "lectures"
    detection_threshold = 0.8
    min_segment_length = 1500  # 25 minutes
    start_number = 39  # Starting number for segments
