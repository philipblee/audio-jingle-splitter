...
class JingleDetector:
    def __init__(self, audio_file_path, jingle_start_time, jingle_end_time, threshold=0.7, min_segment_length=30):
        ...
        self.template = "jingle_template.wav"
        self.template_sr = sr
...
def main():
    ...
    # Configuration
    audio_file_path = "big_history1.m4b"  # Your M4A file
    output_directory = "lectures1"
    ...
    detection_threshold = 0.7  # Much lower threshold for testing
